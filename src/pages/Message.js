          ...
          <div className="modern-message-layout">
            ...
            {isMobile && (
              <button
                ...
                aria-label={
                  showMobileNav ? "Close conversations" : "Open conversations"
                }
              >
            ...
            {/* Chat List Sidebar */}
            <div
              className={`message-sidebar left-sidebar ${isMobile ? (showMobileNav ? "mobile-active" : "mobile-hidden") : ""}`}
            >
