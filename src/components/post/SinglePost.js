                            ...
                            <div className="author-info">
                                <div className="left">
                                    <div className="author-pp">
                                        <UserPP profilePic={postData.author.profilePic} profile={postData.author._id} active={postData.author.isActive}></UserPP>
                                    </div>
                    ...
                    <div className={`nf-post ${type}`}>
                        <div className="header">
                            ...
                            <div className="author-info">
                                <div className="left">
                                    <div className="author-pp">
                                        <UserPP profilePic={postAuthorPP} profile={postData.author._id} active={postData.author.isActive}></UserPP>
                                    </div>
                                    <div className="post-nd-container">
                                        <h4 className="author-name">
                                            <Link to={'/' + postData.author._id}>
