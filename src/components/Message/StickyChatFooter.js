        ...
        <div className="sticky-chat-footer-container">
            {attachmentUrl && (
                <div className="sticky-chat-preview">
                    <img src={attachmentUrl} alt="Preview" className="sticky-chat-preview-img" />
                    <button
            ...
            {isRecording && (
                <div className="sticky-chat-recording-bar">
                    ...
                    <span className="sticky-chat-recording-time">{msToClock(recordingMs)}</span>
            ...
            <div className="sticky-chat-input-wrapper">
                {!isInputFocused && (
                    <div className="sticky-chat-attachment-buttons">
                        ...
                        >
                            <i className={isUploadingFile ? "fas fa-spinner fa-spin" : "fas fa-plus"}></i>
                        </button>
                        <input
                            type="file"
                            ref={uploadFileInput}
                        ...
                        >
                            <i className={isUploadingImage ? "fas fa-spinner fa-spin" : "fas fa-image"}></i>
                        </button>
                        <input
                            type="file"
                            accept="image/*"
