...
const Lightbox = ({ images, imageIndex, setIsLightbox, setImageIndex }) => {
    // const [currentIndex, setCurrentIndex] = useState(imageIndex); // Commented out as it's unused
    // const [direction, setDirection] = useState(0); // Commented out as it's unused
